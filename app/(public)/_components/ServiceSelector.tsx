      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {SERVICES.map((s) => (
          <button
            ...
            className={`
              relative flex flex-col gap-3 rounded border p-6 text-left transition-all duration-200
              ${selected === s.type
          ...
          >
            ...
            {selected === s.type && (
              <span className="absolute right-3 top-3 flex h-5 w-5 items-center justify-center rounded bg-amber-400 text-xs text-black font-bold">
                ✓
              </span>
            )}
          </button>
